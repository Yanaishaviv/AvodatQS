''' this file is used for holding constants. don't modify it!'''
...
# an inverse of the substitution matrix above. allows to find the original number by using 
# it's subtitute in this matrix as an index. wtill works as one long list and not a matrix.
INV_SUB_BYTE_TABLE = [ 
